			...
			<table>
				<?php foreach ($input as $name => $data) : ?>
					...
					<?php elseif($data["type"]=="textarea"): ?>
						<tr>
							<td style="text-align:;"><label class="description" for="nhncss_settings[<?php echo $name; ?>]"><?php _e($data["text"], 'nhncss_domain'); ?></label></td>
							<td><textarea style="height:150px;width:345px;" class="<?php echo $data["class"]; ?>" id="nhncss_settings[<?php echo $name; ?>]" size="45" name="nhncss_settings[<?php echo $name; ?>]" type="text"><?php echo $nhncss_options[$name]; ?></textarea></td>
						</tr>
					<?php endif; ?>
